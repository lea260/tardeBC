...
$nombre    = 'yes';
$ruc       = 'hola';
$direccion = 'no se por que psue el logo este';
$telefono  = '060606060606';
$email     = 'waifus@gmail.com';
// penas
...
$detalle = "compra tecnolgia no hay"; # detalle compra
//$nom = $data->Detalle->Item[1]->NomItem;

$tipoCFE    = "factura ninguna";
$cabezalDoc = "RUT COMPRADOR menos";
$docNumero  = "+111 +111+ 111 +111";
$docRecep   = "RCS: ";
$formaPago  = "contadoS NINGUNOP";
$moneda     = "WFT";

/* datos que llegan como parametros*/
$rucEmpresa = "001 010 010 001";
$rucEmisor  = " RCS";
$nombreCLi  = "Juana";
$domicilio  = "calle falsa no tenemos";
//$array =  (array) $items;
#var_dump($detalle);
