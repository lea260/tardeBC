    ...
    <div class="container">
        ...
        <form id="form01" class="row" action="<?php echo constant('URL'); ?>articulos/actualizar" method="post"
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <input type="text" class="form-control" id="articuloCodigo" name="codigo"
                    value="<?=$this->articulo->codigo;?>">
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12">
                <label for="articuloDescripcion" class="form-label">Descripcion</label>
                <input type="text" class="form-control" id="articuloDescripcion" aria-describedby="emailHelp"
                    name="descripcion" value="<?=$this->articulo->descripcion;?>">
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12">
